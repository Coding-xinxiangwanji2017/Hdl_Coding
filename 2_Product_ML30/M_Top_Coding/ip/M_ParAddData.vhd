...
ENTITY M_ParAddData IS
	PORT
	(
		data0x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data1x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data2x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data3x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data4x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data5x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data6x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		data7x		: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		result		: OUT STD_LOGIC_VECTOR (21 DOWNTO 0)
	);
END M_ParAddData;


ARCHITECTURE SYN OF m_paradddata IS

--	type ALTERA_MF_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire1	: ALTERA_MF_LOGIC_2D (7 DOWNTO 0, 21 DOWNTO 0);
	SIGNAL sub_wire2	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire3	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire4	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire5	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire6	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire7	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire8	: STD_LOGIC_VECTOR (21 DOWNTO 0);
	SIGNAL sub_wire9	: STD_LOGIC_VECTOR (21 DOWNTO 0);

BEGIN
	sub_wire8    <= data0x(21 DOWNTO 0);
	sub_wire7    <= data1x(21 DOWNTO 0);
	sub_wire6    <= data2x(21 DOWNTO 0);
	sub_wire5    <= data3x(21 DOWNTO 0);
	sub_wire4    <= data4x(21 DOWNTO 0);
	sub_wire3    <= data5x(21 DOWNTO 0);
	sub_wire2    <= data6x(21 DOWNTO 0);
	sub_wire0    <= data7x(21 DOWNTO 0);
...
-- Retrieval info: USED_PORT: data3x 0 0 22 0 INPUT NODEFVAL "data3x[21..0]"
-- Retrieval info: USED_PORT: data4x 0 0 22 0 INPUT NODEFVAL "data4x[21..0]"
-- Retrieval info: USED_PORT: data5x 0 0 22 0 INPUT NODEFVAL "data5x[21..0]"
-- Retrieval info: USED_PORT: data6x 0 0 22 0 INPUT NODEFVAL "data6x[21..0]"
-- Retrieval info: USED_PORT: data7x 0 0 22 0 INPUT NODEFVAL "data7x[21..0]"
...
-- Retrieval info: CONNECT: @data 1 3 22 0 data3x 0 0 22 0
-- Retrieval info: CONNECT: @data 1 4 22 0 data4x 0 0 22 0
-- Retrieval info: CONNECT: @data 1 5 22 0 data5x 0 0 22 0
-- Retrieval info: CONNECT: @data 1 6 22 0 data6x 0 0 22 0
-- Retrieval info: CONNECT: @data 1 7 22 0 data7x 0 0 22 0
-- Retrieval info: CONNECT: result 0 0 22 0 @result 0 0 22 0
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_ParAddData.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_ParAddData.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_ParAddData.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_ParAddData.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_ParAddData_inst.vhd FALSE
