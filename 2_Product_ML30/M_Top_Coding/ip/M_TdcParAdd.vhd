...
ARCHITECTURE SYN OF m_tdcparadd IS

--	type ALTERA_MF_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (18 DOWNTO 0);
	SIGNAL sub_wire1	: ALTERA_MF_LOGIC_2D (3 DOWNTO 0, 18 DOWNTO 0);
...
BEGIN
	sub_wire4    <= data0x(18 DOWNTO 0);
	sub_wire3    <= data1x(18 DOWNTO 0);
	sub_wire2    <= data2x(18 DOWNTO 0);
	sub_wire0    <= data3x(18 DOWNTO 0);
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_TdcParAdd.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_TdcParAdd.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_TdcParAdd.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_TdcParAdd.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL M_TdcParAdd_inst.vhd FALSE
