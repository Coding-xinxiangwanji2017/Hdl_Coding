...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/M_NCO_nco_ii_0.v"                     -work nco_ii_0          
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_avalon_reset_source.vhd"       -work M_NCO_inst_rst_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_0002_vhdl_pkg.vhd" -work M_NCO_inst_out_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_0002.vhd"          -work M_NCO_inst_out_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_vhdl_pkg.vhd"      -work M_NCO_inst_in_bfm 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm.vhd"               -work M_NCO_inst_in_bfm 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_avalon_clock_source.vhd"       -work M_NCO_inst_clk_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/M_NCO.vhd"                            -work M_NCO_inst        
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/M_NCO_tb.vhd"                                                            
fi
