...
entity altera_conduit_bfm is
   port (
      clk             : in    std_logic;
      reset           : in    std_logic;
      sig_clken       : out   std_logic_vector(0 downto 0);
      sig_phi_inc_i   : out   std_logic_vector(31 downto 0)
   );
...
architecture altera_conduit_bfm_arch of altera_conduit_bfm is 
   ...
   begin
      ...
      if (clk'event and clk = '1') then
         sig_clken       <= out_trans.sig_clken_out after 1 ps;
         sig_phi_inc_i   <= out_trans.sig_phi_inc_i_out after 1 ps;
         reset_in        <= reset;
      end if;
      end process;
