...
TOP_LEVEL_NAME="M_NCO_tb"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/my_tool/intel_fpga/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/M_NCO_inst_rst_bfm/
mkdir -p ./libraries/M_NCO_inst_out_bfm/
mkdir -p ./libraries/M_NCO_inst_in_bfm/
mkdir -p ./libraries/M_NCO_inst_clk_bfm/
mkdir -p ./libraries/M_NCO_inst/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/M_NCO_nco_ii_0.v"                     -work nco_ii_0           -cdslib ./cds_libs/nco_ii_0.cds.lib          
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_avalon_reset_source.vhd"       -work M_NCO_inst_rst_bfm -cdslib ./cds_libs/M_NCO_inst_rst_bfm.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_0002_vhdl_pkg.vhd" -work M_NCO_inst_out_bfm -cdslib ./cds_libs/M_NCO_inst_out_bfm.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_0002.vhd"          -work M_NCO_inst_out_bfm -cdslib ./cds_libs/M_NCO_inst_out_bfm.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm_vhdl_pkg.vhd"      -work M_NCO_inst_in_bfm  -cdslib ./cds_libs/M_NCO_inst_in_bfm.cds.lib 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_conduit_bfm.vhd"               -work M_NCO_inst_in_bfm  -cdslib ./cds_libs/M_NCO_inst_in_bfm.cds.lib 
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/altera_avalon_clock_source.vhd"       -work M_NCO_inst_clk_bfm -cdslib ./cds_libs/M_NCO_inst_clk_bfm.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/submodules/M_NCO.vhd"                            -work M_NCO_inst         -cdslib ./cds_libs/M_NCO_inst.cds.lib        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/M_NCO_tb/simulation/M_NCO_tb.vhd"                                                                                                          
fi
