...
##vcom  ../rtl/*.vhd
vcom  -work work ../ip/M_DdrCtrl/user_design/rtl/*.vhd
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/clocking/*.v
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/controller/*.v
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/ecc/*.v
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/ip_top/*.v
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/phy/*.v
vlog  -work work -incr ../ip/M_DdrCtrl/user_design/rtl/ui/*.v
vcom  -work work ../ip/M_DdrCtrl/user_design/rtl/phy/*.vhd
vlog  -work work -incr ../ip/M_DdrCtrl/example_design/sim/wiredly.v
